...
gulp.task('templates', function() {
	...
	return gulp.src(manifest.dependencies['templates.js'].files)
		.pipe(nunjucks.precompile())
		.pipe(concat('templates.js'))
		.pipe(gulp.dest(manifest.paths.dist + '/js'))
		.pipe(notify('Compiled templates, <%= file.relative %>'));
});
...
gulp.task('watch', function() {
	...
	gulp.watch(manifest.dependencies['templates.js'].files, ['templates']);
});
...
// Default task
gulp.task('default', ['init', 'less', 'js', 'templates', 'watch']);
